...
> = {
  ...
  APPROVAL: { icon: ShieldCheck, title: "Approval required", body: (e) => `Requests to join this ${e} wait for your decision. Approve or decline each one below.`, tone: "bg-surface-warning border-border text-foreground" },
  ...
  PAID: { icon: CreditCard, title: "Paid membership", body: (e) => `Members join this ${e} after paying. A request appears here only once its payment succeeds.`, tone: "bg-surface-success border-border text-foreground" },
};
