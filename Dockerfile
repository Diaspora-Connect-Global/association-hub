...
# association-hub — Vite/React SPA → nginx static server for Cloud Run.
...
# NOTE: the repo .env uses a relative "/graphql"; for a static host we MUST
# point at the absolute API origin instead.
